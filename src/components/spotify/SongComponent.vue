<template>
  <div class="image-container" style="width: 100%">
    <img
      :src="`/img/pixels/song_${props.index + 1}.jpg`"
      style="width: 100%"
      :alt="props.song.name + ' cover'"
      class="logo"
    />
    <div class="hover-text">
      <h3>
        <a :href="props.song.url" target="_blank" class="link-bright">{{ props.song.name }}</a>
      </h3>
    </div>
    <div class="author-text">
      <a
        v-for="artist in props.song.artists"
