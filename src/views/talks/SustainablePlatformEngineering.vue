      ...
      <template #content>
        ...
        <LayoutRow>
          <div style="width: 48%; display: flex; justify-content: center">
            <p>>>></p>
            <a
              href="https://www.youtube.com/embed/lTLttAcs1zE?si=EdE_M3TAI53or9WX"
          ...
          <div style="width: 48%; display: flex; justify-content: center">
            <p>>>></p>
            <a
              href="https://www.slideshare.net/slideshow/sustainable-platform-engineering-having-a-green-thumb-without-shooting-up-the-costs-dario-gutierrez-mori/277450234"
              style="align-content: center; margin: 10px"
            >
              {{ t('projects.talks.kcd-guadalajara.slides') }}
            </a>
            <p>{{ '<<<' }}</p>
          </div>
        </LayoutRow>
        <LayoutRow style="justify-content: space-around">
          <img
            :src="'../../img/projects/talks/sustainability/talk-title.png'"
            class="image-display"
            style="width: 40%; height: 30%; rotate: 7deg"
          />
          <img
            :src="'../../img/projects/talks/sustainability/talk-1.png'"
            class="image-display"
            style="width: 40%; height: 30%; rotate: -7deg"
          />
        </LayoutRow>
        ...
        <LayoutRow style="justify-content: space-around">
          <img
            :src="'../../img/projects/talks/sustainability/guadalajara-1.png'"
            class="image-display"
            style="width: 40%"
          />
        </LayoutRow>
        ...
        <img
          ...
          src="/img/projects/talks/sustainability/logo-kcd.png"
          class="image-display"
          style="width: 120px"
        />
    ...
    <LayoutRow style="justify-content: end">
      <div class="fake-ad" v-if="ad.show">
        <div style="justify-content: space-between; align-content: end; display: flex">
          <h3 class="cool-3d-text">Watch now!</h3>
          <el-button
            class="cool-3d-text"
            @click="ad.show = false"
        ...
        <a
          href="https://www.youtube.com/watch?v=lTLttAcs1zE"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            alt="Main Presentation"
            src="/img/projects/talks/sustainability/promo-1.png"
            style="width: 100%; cursor: pointer; border: 3px solid var(--secondary-color)"
          />
        </a>
      </div>
    </LayoutRow>
...
const images = ['talk-title.jpg', 'guadalajara-1.jpg', 'talk-1.jpg']
</script>
