                            ...
                            <el-row justify="center" align="middle">
                                ...
                                <el-col :span="10">
                                    <el-row align="middle">
                                        ...
                                        <el-col :span="8">
                                            <img :src="strawberry" style="width:100% " />
                                        </el-col>
                                    </el-row>
                                </el-col>
                            </el-row>
                        </el-column>
                        <el-column :span="18" style="flex:auto">
                        </el-column>
                    </el-row>
            </el-col>
                            ...
                            <el-row justify="end">
                                ...
                                <el-col :span="12">
                                    <el-menu-item index="2" @click="active.activeIndex='2'">
                                        <img :src="active.activeIndex === '2' ? goldenActive : goldenInactive" class="inside-button">
                                    </el-menu-item>
                                </el-col>
                            </el-row>
                        </el-menu>
                ...
                <el-card class="content-celeste">
                    <el-row justify="center" v-if="active.activeIndex==='1'">
                            <el-col :span="3" v-for="index in 8" :key="index">
                                ...
                                <img :src="heartsAside[index-1]? heartBlue : dot" style="width:80%" class="heart"/>
                                <img :src="heartsBside[index-1]? heartRed : dot" style="width:80%" class="heart"/>
                                <img :src="heartsCside[index-1]? heartYellow : dot" style="width:80%" class="heart"/>
                            </el-col>
                    </el-row>
